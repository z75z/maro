...
async def games2(c: Client, m: CallbackQuery):
    ...
    await m.message.edit_text("◍ أهلا بيك بقائمه العاب سورس دريم قم باختيار احذى الازرار\n√", reply_markup=keyboard)
...
async def games(c: Client, m: Message):
    if m.text == "الالعاب" or m.text == "الألعاب" or m.text == "ألعاب" or m.text == "لعبه" or m.text == "لعبة":
        if not lock_games_test(m):
            ...
            await m.reply_text("◍ أهلا بيك بقائمه العاب سورس دريم قم باختيار احذى الازرار\n√", reply_markup=keyboard)
        else:
    ...
    if m.text == "صراحه" or m.text == "لعبه صراحه" or m.text == "لعبة صراحة" or m.text == "صراحة":
        if not lock_games_test(m):
            ...
            await m.reply_text(random.choice(saraha))
    ...
    if m.text == "مريم" or m.text == "لعبه مريم" or m.text == "لعبة مريم" or m.text == "العاب مريم":
        if not lock_games_test(m):
            ...
            await m.reply_text(random.choice(mariam))
    ...
    if m.text == "عقاب" or m.text == "لعبه عقاب" or m.text == "لعبة عقاب" or m.text == "العاب عقاب":
        if not lock_games_test(m):
            ...
            await m.reply_text(random.choice(eqab))
    ...
    if m.text == "نسبه جمالى" or m.text == "نسبة جمالي" or m.text == "جمالي":
        if not lock_myphoto_test(m):
            if sudo2(m):
                ...
                try:
                    await c.get_chat_photos(m.from_user.id, limit=1).__anext__()
                except:
                    await m.reply_text("◍ للاسف لايوجد صوره لديك\n√")
                else:
                    async for photo in c.get_chat_photos(m.from_user.id, limit=1):
                            await m.reply_photo(photo.file_id, caption="◍ نسبه جمالك هي ~⪼ " + random.choice(gmalnumbers) + "% ❤️🙄")
        else:
            await m.reply_text("◍ صورتي معطله يرجى تفعيلها اولا\n√")

    if m.text == "كشف الكذب" or m.text == "كشف الكدب":
        if not lock_games_test(m):
            await m.reply_text("ارسل لى الجمله لتعرف صدق ام كذب😳😂")
    ...
    if m.text == "تويت" or m.text == "كت تويت" or m.text == "تويته" or m.text == "كات تويت" or m.text == "كت":
        if not lock_games_test(m):
            tweet = [
                ...
                " كت تويت | تغار ..؟!",
                " كت تويت | هـل تعتقـد ان في أحـد يراقبـك . . .؟!",
                " كت تويت | أشخاص ردتهم يبقون وياك ومن عرفو هلشي سوو العكس صارت معك؟",
                " كت تويت | ولادتك بنفس المكان الي هسة عايش بي او لا؟",
                " كت تويت | اكثر شي ينرفزك ؟",
                " كت تويت | كم تبلغ ذاكرة هاتفك؟",
                " كت تويت | صندوق اسرارك ؟",
                " كت تويت | شخص @ تعترفلة بشي ؟",
                " كت تويت | يومك ضاع على ؟",
                " كت تويت | اغرب شيء حدث في حياتك ؟",
                " كت تويت | نسبة حبك للاكل ؟",
                " كت تويت | حكمة تأمان بيها ؟",
                " كت تويت | اكثر شي ينرفزك ؟",
                " كت تويت | هل تعرضت للظلم من قبل؟",
                " كت تويت | خانوك ؟",
                " كت تويت | تاريخ غير حياتك ؟",
                " كت تويت | أجمل سنة ميلادية مرت عليك ؟",
                " كت تويت | ولادتك بنفس المكان الي هسة عايش بي او لا؟",
                " كت تويت | تزعلك الدنيا ويرضيك ؟",
                " كت تويت | ماهي هوايتك؟",
                " كت تويت | دوله ندمت انك سافرت لها ؟",
                " كت تويت | شخص اذا جان بلطلعة تتونس بوجود؟",
                " كت تويت | تاخذ مليون دولار و تضرب خويك؟",
                " كت تويت | تاريخ ميلادك؟",
                " كت تويت | اشكم مره حبيت ؟",
                " كت تويت | يقولون ان الحياة دروس ، ماهو أقوى درس تعلمته من الحياة ؟",
                " كت تويت | هل تثق في نفسك ؟",
                " كت تويت | كم مره نمت مع واحده ؟",
                " كت تويت | اسمك الثلاثي ؟",
                " كت تويت | كلمة لشخص خذلك؟",
                " كت تويت | هل انت متسامح ؟",
                " كت تويت | طريقتك المعتادة في التخلّص من الطاقة السلبية؟",
                " كت تويت | عصير لو قهوة؟",
                " كت تويت | تثق بـ احد ؟",
                " كت تويت | كم مره حبيت ؟",
                " كت تويت | اكمل الجملة التالية..... قال رسول الله ص،، انا مدينة العلم وعلي ؟",
                " كت تويت | اوصف حياتك بكلمتين ؟",
                " كت تويت | حياتك محلوا بدون ؟",
                " كت تويت | وش روتينك اليومي؟",
                " كت تويت | شي تسوي من تحس بلملل؟",
                " كت تويت | اكثر مشاكلك بسبب ؟",
                " كت تويت | تتوقع فيه احد حاقد عليك ويكرهك ؟",
                " كت تويت | كلمة غريبة من لهجتك ومعناها؟",
                " كت تويت | هل تحب اسمك أو تتمنى تغييره وأي الأسماء ستختار",
                " كت تويت | كيف تشوف الجيل ذا؟",
                " كت تويت | تاريخ لن تنساه📅؟",
                " كت تويت | هل من الممكن أن تقتل أحدهم من أجل المال؟",
                " كت تويت | تؤمن ان في حُب من أول نظرة ولا لا ؟.",
                "‏ كت تويت | ماذا ستختار من الكلمات لتعبر لنا عن حياتك التي عشتها الى الآن؟💭",
                " كت تويت | طبع يمكن يخليك تكره شخص حتى لو كنت تُحبه🙅🏻‍♀️؟",
                " كت تويت | ما هو نوع الموسيقى المفضل لديك والذي تستمع إليه دائمًا؟ ولماذا قمت باختياره تحديدًا؟",
                " كت تويت | أطول مدة نمت فيها كم ساعة؟",
                " كت تويت | كلمة غريبة من لهجتك ومعناها؟🤓",
                " كت تويت | ردة فعلك لو مزح معك شخص م تعرفه ؟",
                " كت تويت | شخص تحب تستفزه😈؟",
                " كت تويت | تشوف الغيره انانيه او حب؟",
                " كت تويت | مع او ضد : النوم افضل حل لـ مشاكل الحياة؟",
                " كت تويت | اذا اكتشفت أن أعز أصدقائك يضمر لك السوء، موقفك الصريح؟",
                "‏ كت تويت | للشباب | آخر مرة وصلك غزل من فتاة؟🌚",
                " كت تويت | أوصف نفسك بكلمة؟",
                " كت تويت | شيء من صغرك ماتغير فيك؟",
                " كت تويت | ردة فعلك لو مزح معك شخص م تعرفه ؟",
                " كت تويت | اذا شفت حد واعجبك وعندك الجرأه انك تروح وتتعرف عليه ، مقدمة الحديث شو راح تكون ؟.",
                " كت تويت | كلمة لشخص أسعدك رغم حزنك في يومٍ من الأيام ؟",
                " كت تويت | حاجة تشوف نفسك مبدع فيها ؟",
                " كت تويت | يهمك ملابسك تكون ماركة ؟",
                " كت تويت | يومك ضاع على؟",
                " كت تويت | اذا اكتشفت أن أعز أصدقائك يضمر لك السوء، ماموقفك الصريح؟",
                " كت تويت | هل من الممكن أن تقتل أحدهم من أجل المال؟",
                " كت تويت | كلمه ماسكه معك الفترة هذي ؟",
                " كت تويت | كيف هي أحوال قلبك؟",
                " كت تويت | صريح، مشتاق؟",
                " كت تويت | اغرب اسم مر عليك ؟",
                " كت تويت | تختار أن تكون غبي أو قبيح؟",
                " كت تويت | آخر مرة أكلت أكلتك المفضّلة؟",
                " كت تويت | دوله ندمت انك سافرت لها😁؟",
                " كت تويت | اشياء صعب تتقبلها بسرعه ؟",
                " كت تويت | كلمة لشخص غالي اشتقت إليه؟💕",
                " كت تويت | اكثر شيء تحس انه مات ف مجتمعنا؟",
                " كت تويت | هل يمكنك مسامحة شخص أخطأ بحقك لكنه قدم الاعتذار وشعر بالندم؟",
                " كت تويت | آخر شيء ضاع منك؟",
                " كت تويت | تشوف الغيره انانيه او حب؟",
                " كت تويت | لو فزعت/ي لصديق/ه وقالك مالك دخل وش بتسوي/ين؟",
                " كت تويت | شيء كل م تذكرته تبتسم ...",
                " كت تويت | هل تحبها ولماذا قمت باختيارها؟",
                " كت تويت | هل تنفق مرتبك بالكامل أم أنك تمتلك هدف يجعلك توفر المال؟",
                " كت تويت | متى تكره الشخص الذي أمامك حتى لو كنت مِن أشد معجبينه؟",
                " كت تويت | أقبح القبحين في العلاقة: الغدر أو الإهمال🤷🏼؟", 
                " كت تويت | هل وصلك رسالة غير متوقعة من شخص وأثرت فيك ؟",
                " كت تويت | هل تشعر أن هنالك مَن يُحبك؟",
                " كت تويت | وش الشيء الي تطلع غضبك فيه لو زعلت ؟",
                " كت تويت | صوت مغني م تحبه",
                " كت تويت | كم في حسابك البنكي ؟",
                " كت تويت | اذكر موقف ماتنساه بعمرك؟",
                " كت تويت | ردة فعلك لو مزح معك شخص م تعرفه ؟",
                " كت تويت | عندك حس فكاهي والا نفسية؟",
                " كت تويت | من وجهة نظرك ما هي الأشياء التي تحافظ على قوة وثبات العلاقة؟",
                " كت تويت | ما هو نوع الموسيقى المفضل لديك والذي تستمع إليه دائمًا؟ ولماذا قمت باختياره تحديدًا؟",
                " كت تويت | هل تنفق مرتبك بالكامل أم أنك تمتلك هدف يجعلك توفر المال؟",
                " كت تويت | هل وصلك رسالة غير متوقعة من شخص وأثرت فيك ؟",
                " كت تويت | شيء من صغرك ماتغير فيك؟",
                " كت تويت | هل يمكنك أن تضحي بأكثر شيء تحبه وتعبت للحصول عليه لأجل شخص تحبه؟",
                " كت تويت | هل تحبها ولماذا قمت باختيارها؟",
                " كت تويت | لو فزعت/ي لصديق/ه وقالك مالك دخل وش بتسوي/ين؟",
                " كت تويت | كلمة لشخص أسعدك رغم حزنك في يومٍ من الأيام ؟",
                " كت تويت | كم مره تسبح باليوم",
                " كت تويت | أفضل صفة تحبه بنفسك؟",
                " كت تويت | أجمل شيء حصل معك خلال هاليوم؟",
                "‏ كت تويت | شيء سمعته عالق في ذهنك هاليومين؟",
                " كت تويت | هل يمكنك تغيير صفة تتصف بها فقط لأجل شخص تحبه ولكن لا يحب تلك الصفة؟",
                "‏ كت تويت | أبرز صفة حسنة في صديقك المقرب؟",
                " كت تويت | ما الذي يشغل بالك في الفترة الحالية؟",
                " كت تويت | آخر مرة ضحكت من كل قلبك؟",
                " كت تويت | اكثر دوله ودك تسافر لها🏞؟",
                " كت تويت | آخر خبر سعيد، متى وصلك؟",
                "‏ كت تويت | نسبة احتياجك للعزلة من 10📊؟",
                " كت تويت | هل تنفق مرتبك بالكامل أم أنك تمتلك هدف يجعلك توفر المال؟",
                " كت تويت | أكثر جملة أثرت بك في حياتك؟",
                " كت تويت | لو قالوا لك  تناول صنف واحد فقط من الطعام لمدة شهر .",
                " كت تويت | هل تنفق مرتبك بالكامل أم أنك تمتلك هدف يجعلك توفر المال؟",
                " كت تويت | آخر مرة ضحكت من كل قلبك؟",
                " كت تويت | وش الشيء الي تطلع غضبك فيه لو زعلت ؟",
                " كت تويت | متى تكره الشخص الذي أمامك حتى لو كنت مِن أشد معجبينه؟",
                " كت تويت | تعتقد فيه أحد يراقبك👩🏼‍💻؟",
                " كت تويت | احقر الناس هو من ...",
                " كت تويت | شيء من صغرك ماتغير فيك؟",
                " كت تويت | وين نلقى السعاده برايك؟",
                " كت تويت | هل تغار/تغارين من صديقاتك/اصدقائك ؟؟",
                " كت تويت | أكثر جملة أثرت بك في حياتك؟",
                " كت تويت | كم عدد اللي معطيهم بلوك👹؟",
                " كت تويت | أجمل سنة ميلادية مرت عليك ؟",
                " كت تويت | أوصف نفسك بكلمة؟",

            ]
            await m.reply_text(random.choice(tweet))
        else:
            await m.reply_text("◍ الالعاب معطله يرجى تفعيلها اولا\n√")
    ...
    if m.text == "تويت بالصور" or m.text == "كت تويت بالصور" or m.text == "كات تويت بالصور":
        if not lock_games_test(m):
            ...
            await m.reply_photo("https://t.me/cattwit/" + random.choice(tweetphoto))
        else:
            await m.reply_text("◍ الالعاب معطله يرجى تفعيلها اولا\n√")


    if m.text == "تتجوزيني" or m.text == "تتجوزينى" or m.text == "تتزوجيني" and m.reply_to_message:
        global mid
        mid = m.id
        keyboard = InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton("موافقه", callback_data="gyesgame " + str(m.reply_to_message.from_user.id))] +
            [InlineKeyboardButton("مش موافقه", callback_data="gnogame " + str(m.reply_to_message.from_user.id))],
        ])
        await m.reply_text(f"◍ اهلا عزيزتي [{m.reply_to_message.from_user.first_name}](tg://user?id={m.reply_to_message.from_user.id}) 🤤\n◍ طلب [{m.from_user.first_name}](tg://user?id={m.from_user.id}) الزواج منكى\n◍ هل تقبلين الزواج به؟ ❤️🥺\n√", reply_markup=keyboard, parse_mode=enums.ParseMode.MARKDOWN)
    ...
    if m.text == "نمله" or m.text == "النمله":
        if not lock_games_test(m):
            ...
            await m.reply_photo("https://t.me/UUSDI55/41", reply_markup=keyboard)
        else:
            await m.reply_text("◍ الالعاب معطله يرجى تفعيلها اولا\n√")
    ...
    if m.text == "صرصار" or m.text == "صرصور" or m.text == "الصرصار":
        if not lock_games_test(m):
            ...
            await m.reply_photo("https://t.me/UUSDI55/42", reply_markup=keyboard)
        else:
            await m.reply_text("◍ الالعاب معطله يرجى تفعيلها اولا\n√")
    ...
    if m.text == "خنزير" or m.text == "خنزيره" or m.text == "الخنزير":
        if not lock_games_test(m):
            ...
            await m.reply_photo("https://t.me/UUSDI55/43", reply_markup=keyboard)
        else:
            await m.reply_text("◍ الالعاب معطله يرجى تفعيلها اولا\n√")



@Client.on_callback_query(filters.regex("^gyesgame (\d+)$"))
async def gyesgame(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="مش طالب ايدك انتى احنا هنتلزق 🖤🙂", show_alert=True)
        return
    textmessage = [
        f"الاخت [{m.from_user.first_name}](tg://user?id={m.from_user.id}) وافقت على [{m.message.reply_to_message.from_user.first_name}](tg://user?id={m.message.reply_to_message.from_user.id}) وااه لقيت الطبطبه واقوى لو مانتاش بعيد😂😂🤤",
        f"اختنا الفاضله [{m.from_user.first_name}](tg://user?id={m.from_user.id}) وافقت على زواجها بالأخ الفاضل [{m.message.reply_to_message.from_user.first_name}](tg://user?id={m.message.reply_to_message.from_user.id})🥺❤️ رشو الشارع ميه وزيت عريسنا الغالي جاي البيت 😂😂💃🔊",
        f"تم زواج الأخت [{m.from_user.first_name}](tg://user?id={m.from_user.id}) للأخ [{m.message.reply_to_message.from_user.first_name}](tg://user?id={m.message.reply_to_message.from_user.id}) وبارك الله لهما ولنا وكفايه كده لا تتجوزو بجد 😂❤️",
        f"تم زواج الآنسه [{m.from_user.first_name}](tg://user?id={m.from_user.id}) للاخ الفاضل [{m.message.reply_to_message.from_user.first_name}](tg://user?id={m.message.reply_to_message.from_user.id}) والآن يستطيعان عمل واحد 🤤❤️😂",
        f"ابغي اجوز الانسه [{m.from_user.first_name}](tg://user?id={m.from_user.id}) للاستاذ [{m.message.reply_to_message.from_user.first_name}](tg://user?id={m.message.reply_to_message.from_user.id}) الحين واجيب شبكه واعمل فرح ولولولولولولي وياحنا يابسكويت 😂😂 💃"
    ]
    await m.message.delete()
    await m.message.reply_text(random.choice(textmessage), parse_mode=enums.ParseMode.MARKDOWN)

@Client.on_callback_query(filters.regex("^gnogame (\d+)$"))
async def gnogame(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="مش طالب ايدك انتى احنا هنتلزق 🖤🙂", show_alert=True)
        return
    textmessage = [
        f"لما [{m.from_user.first_name}](tg://user?id={m.from_user.id}) ترفضك يبقى كسفتك ياحازم [{m.message.reply_to_message.from_user.first_name}](tg://user?id={m.message.reply_to_message.from_user.id}) 😂😂😂",
        f"ينيلك ياخايبه [{m.from_user.first_name}](tg://user?id={m.from_user.id}) حد طايل قمر زى [{m.message.reply_to_message.from_user.first_name}](tg://user?id={m.message.reply_to_message.from_user.id}) 🥺💗",
        f"فكري تاني يا [{m.from_user.first_name}](tg://user?id={m.from_user.id}) عشان بجد الواد [{m.message.reply_to_message.from_user.first_name}](tg://user?id={m.message.reply_to_message.from_user.id}) جامد فحت 🙂❤️",
        f"الست هانم [{m.from_user.first_name}](tg://user?id={m.from_user.id}) بترفض اى عريس يعني بزمتكم هتلاقى احسن من [{m.message.reply_to_message.from_user.first_name}](tg://user?id={m.message.reply_to_message.from_user.id}) فين 🥺❤️",
        f"رفضت [{m.from_user.first_name}](tg://user?id={m.from_user.id}) الزواج ب [{m.message.reply_to_message.from_user.first_name}](tg://user?id={m.message.reply_to_message.from_user.id}) الحين عشان هو علق وبيشقط فى حد وخلاص 😂😂 💃"
    ]
    await m.message.delete()
    await m.message.reply_text(random.choice(textmessage), parse_mode=enums.ParseMode.MARKDOWN)
...
async def antgame(c: Client, m: CallbackQuery):
    ...
    await m.message.delete()
    await m.message.reply_photo("https://t.me/UUSDI55/44",
...
async def cockroachgame(c: Client, m: CallbackQuery):
    ...
    await m.message.delete()
    await m.message.reply_animation("https://t.me/UUSDI55/45",
...
async def piggame(c: Client, m: CallbackQuery):
    ...
    await m.message.delete()
    await m.message.reply_photo("https://t.me/UUSDI55/46",
