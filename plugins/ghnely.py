...
async def klthom(c: Client, m: CallbackQuery):
    ...
    if m.message.reply_to_message:
        await m.message.reply_to_message.reply_audio("https://t.me/UUDDSSII/" + random.choice(ghnelyaudio),
                                caption=f"By: @{get_bot_information()[1]}"),
    else:
        await m.message.reply_audio("https://t.me/UUDDSSII/" + random.choice(ghnelyaudio),
                                caption=f"By: @{get_bot_information()[1]}"),
